     ...
     px-4  md:flex-row">
        <div className="flex flex-col justify-center h-full">
             <h2 className=" text-4xl sm:text-7xl font-bold text-white">
                I'm a Software and MERN Stack Developer
             </h2>
             <p className="text-gray-500 py-4 max-w-md">I have 2 years of experience  buildig and designing
                software.
                Currently, I love to work on Web applications using 
                technologies like
                React,Tailwind, Next JS and Data Structure And Alogorithm.
             </p>
             <div>
